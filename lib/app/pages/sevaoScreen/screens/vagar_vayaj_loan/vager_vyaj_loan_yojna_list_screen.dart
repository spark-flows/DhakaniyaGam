...
class VagerVyajeLoanScreen extends StatelessWidget {
  const VagerVyajeLoanScreen({super.key});
      ...
      builder: (controller) {
        return Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () {
              RouteManagement.goToLoanniVigatScreen();
            },
          ...
          body: SafeArea(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                var item = controller.loanList[index];
                return Padding(
