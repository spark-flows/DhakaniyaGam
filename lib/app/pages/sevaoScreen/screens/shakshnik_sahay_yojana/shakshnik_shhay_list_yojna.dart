...
class SekshanikSahayYojnaScreen extends StatelessWidget {
  const SekshanikSahayYojnaScreen({super.key});
    ...
    return GetBuilder<SevaoController>(
      ...
      builder: (controller) => Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            RouteManagement.goToaddAbhyasKartiDikriScreen();
          },
        ...
        body: SafeArea(
          ...
          child: ListView.builder(
            itemCount: controller.scolarshipsList.length,
            itemBuilder: (context, index) {
              var item = controller.scolarshipsList[index];
              return Padding(
                padding: Dimens.edgeInsetsBottom30,
                child: Container(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              Utility.getTimeStempToDate(item.createTimestamp),
