...
class SalahakarSamitiScreen extends StatelessWidget {
  const SalahakarSamitiScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<DashboardController>(initState: (state) {
      ...
      controller.pagingCommitteeController
        ...
        await controller.postCommitteemembers(pageKey, "advisory_committee");
      });
    }, builder: (controller) {
      return Scaffold(
